...
export function HeroSection() {
    ...
    return (
        <section
            id="home"
            className="pt-10 pb-16 md:pt-20 md:pb-15 bg-gradient-to-br from-primary/5 via-background to-background"
        >
                    ...
                    <div className="flex flex-col justify-center space-y-6 order-2 md:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-4">
                            <button
                                ...
                                className="px-6 md:px-8 py-2 md:py-3 bg-primary text-white rounded-lg font-semibold hover:bg-primary-dark transition-colors flex items-center justify-center gap-2 text-sm md:text-base"
                            >
                                {t("hero.cta")}
