...
import { Menu, X, Sun, Moon, Home, Briefcase, Building2, LogOut, User } from 'lucide-react'
                            ...
                            {navItems.map((item) => {
                                ...
                                return (
                                    <Link
                                        key={item.href}
                                        href={item.href}
                                        className={`flex items-center gap-2 transition-colors font-medium pb-1 border-b-2 ${active
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center bg-muted rounded-lg p-1">
                                <button
                                    ...
                                    className={`px-2 py-1 rounded transition-colors text-sm font-medium ${language === "en" ? "bg-primary text-white" : "text-foreground hover:bg-background"
                                        }`}
                                >
                                    EN
                                </button>
                                <button
                                    ...
                                    className={`px-2 py-1 rounded transition-colors text-sm font-medium ${language === "fr" ? "bg-primary text-white" : "text-foreground hover:bg-background"
                                        }`}
                                >
                                    FR
                                </button>
                            ...
                            {isAuthenticated ? (
                                <div className="hidden sm:flex items-center gap-2">
                                    ...
                                    <button
                                        onClick={logout}
                                        className="p-2 rounded-lg bg-red hover:bg-border transition-colors"
                                        aria-label="Logout"
                                    >
                                ...
                                <button
                                    ...
                                    className="hidden sm:inline px-4 py-2 bg-primary text-white rounded-lg font-semibold hover:bg-primary/90 transition-colors"
                                >
                                    {t("auth.login")}
                                </button>
                            )}
                            ...
                            {isAuthenticated ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2 bg-muted rounded-lg font-semibold hover:bg-border transition-colors text-left"
                                    >
